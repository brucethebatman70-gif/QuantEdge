  ...
  return (
    <section className="relative px-6 py-32">
      <div className="max-w-lg mx-auto text-center">
        ...
        >
          Start every trade<br />
          <span className="text-[#00D4AA]">with an edge.</span>
        </motion.h2>
        ...
        >
          Join thousands of professional traders using QuantEdge to<br />
          track, analyze, and improve every trade they take.
        </motion.p>
        ...
        >
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[11px] text-muted-foreground/40">
            <span>&copy; {new Date().getFullYear()} {brand.company}. All rights reserved.</span>
            <Link href="/legal/privacy" className="hover:text-foreground/60 transition-colors">Privacy</Link>
            <Link href="/legal/terms" className="hover:text-foreground/60 transition-colors">Terms</Link>
            <Link href="mailto:support@quantedge.io" className="hover:text-foreground/60 transition-colors">Contact</Link>
          </div>
        </motion.div>
      </div>
    </section>
